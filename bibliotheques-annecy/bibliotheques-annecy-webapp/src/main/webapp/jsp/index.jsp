...
<html>
	...
	<body>
		<div class="container">
			...
			<section>
				<h1>Sélection Juillet 2018</h1>
				
				<h2>Mort sur le nil</h2>
				<p class="text-justify">Quoi de plus reposant et tranquille qu’une croisière sur le Nil ? Sauf quand on retrouve à bord le corps de Linnet Ridgeway tuée d’une balle dans la tête. 
					...
					sur la gâchette ! »  Mais cette déclaration, si elle n’est pas anodine, ne fait pas forcément de vous le coupable idéal.
				</p>
				
				<h2>Le meurtre de Roger Ackroyd</h2>
				<p class="text-justify">Roger Ackroyd se confie un soir à son vieil ami le Dr Sheppard. Il était sur le point d’épouser une jeune et richissime veuve quand celle-ci a mis fin à 
					ses jours pour échapper à un affreux chantage. Dans sa dernière lettre elle lui livre un secret terrible : un an plus tôt, elle a assassiné son mari !
				</p>
		
				<h2>Dans la combi de Thomas Pesquet</h2>
				<p class="text-justify">Le 2 juin dernier, le Français Thomas Pesquet, 38 ans, astronaute, rentrait sur Terre après avoir passé 6 mois dans la Station spatiale internationale. 
					...
					sa mission dans l'ISS et son retour sur Terre.
				</p>
					
				<h2>Game of Thrones - Tome 01 : Le trône de fer</h2>
				<p>Il était une fois, perdu dans un lointain passé, le royaume des Sept Couronnes... En ces temps nimbés de brume, où la belle saison pouvait 
					...
					et à la fourberie. Mais dans ce tourbillon d’aventures cruelles, ce sont finalement l’amour, la tendresse, l’indestructible force de l’amitié qui rayonnent au-dessus des ténèbres.
				</p>	
				
				<h2>Une brève histoire du temps : Du big bang aux trous noirs</h2>
				<p>Stephen Hawking est universellement reconnu comme un des plus grands cosmologistes de notre époque et l'un des plus brillants 
