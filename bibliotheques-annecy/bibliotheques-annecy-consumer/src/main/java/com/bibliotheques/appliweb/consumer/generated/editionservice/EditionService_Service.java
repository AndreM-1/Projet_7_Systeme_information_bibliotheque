 ...
 * 2018-08-01T11:37:28.988+02:00
 * Generated source version: 3.2.5
 *
 */
@WebServiceClient(name = "EditionService",
                  wsdlLocation = "file:/D:/Parcours_Developpeur_Application_Java/Projet_7_Systeme_information_bibliotheque/bibliotheques-annecy/bibliotheques-annecy-consumer/src/main/resources/wsdl/EditionService.wsdl",
...
public class EditionService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Parcours_Developpeur_Application_Java/Projet_7_Systeme_information_bibliotheque/bibliotheques-annecy/bibliotheques-annecy-consumer/src/main/resources/wsdl/EditionService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EditionService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Parcours_Developpeur_Application_Java/Projet_7_Systeme_information_bibliotheque/bibliotheques-annecy/bibliotheques-annecy-consumer/src/main/resources/wsdl/EditionService.wsdl");
        }
        WSDL_LOCATION = url;
    }
